...
class Config:
    ...
    def __init__(self, 
        ...
        self.prompt = {
            'filler': "I'm like, you know what I mean, kind of, um, ah, huh, and so, so um, uh, and um, like um, so like, like it's, it's like, i mean, yeah, ok so, uh so, so uh, yeah so, you know, it's uh, uh and, and uh, like, kind", # this helps whisper detect filler words, and thus allow us to remove them
            'domain': "Iman Mossavat, \"Iman Mossavat\", Fontys, Eindhoven, Diederik roijers, Brainport, TUE (technical university of Eindhoven), legistavely, GDPR " # use any organizations and names that appear in the text if you expect Whisper not to transcribe them correctly. 
        }
